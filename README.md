...
>
> net模块是TCP/IP的Node实现，提供了一些用于底层的网络通信的小工具
>
...
>
> - net.Socket：本地socket的node版实现，它实现了全双工的stream

###### 2.3 net.Socket

> net.Socket对象是TCP 或 UNIX Socket 的抽象
>
...
> HTTP模块是Node 的门脸，是编写Web Server最常见的模块
>
> Server部分继承自net.Server，并对请求和响应数据进行了封装
>
> 也提供了 request/get的能力（也是从Socket封装上来的），允许高其他服务端发起HTTP请求
>
